                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-blue-800 text-sm">
                          Similar professionals save <strong>{benchmarkData.avg_hours_saved_weekly} hours/week</strong> with {moduleData.title} 
                          (satisfaction: {benchmarkData.median_satisfaction_score}/10)
                        </p>
...
export default FirebaseQuestionnaireModal;